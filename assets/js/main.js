...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const compressionLevels = ['NA', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C8', 'C9', 'C11', 'C12', 'C13', 'C14', 'C15', 'C16', 'C17', 'C18', 'C19', 'C20', 'C29', 'C30', 'C31', 'C32', 'C33'];
...
const plotSizes = {
  "GB": {
    ...
    "C29" : {"k30": 1,"k31": 1,"k32": 51.539 , "k33": 105.119, "k34": 230.038},
  ...
  "GIB": {
    ...
    "C29" : {"k30": 1,"k31": 1,"k32": 48.000 , "k33": 97.900, "k34": 214.240},
